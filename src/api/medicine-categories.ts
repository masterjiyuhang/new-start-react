 ...
 * @returns
 */
export const delByIdAPI = (id: string) => del('/admin/medicine_categories/' + id)
 ...
 * @returns
 */
export const delManyByIds = (ids: string) => del('/admin/medicine_categories/remove_many?ids=' + ids)
