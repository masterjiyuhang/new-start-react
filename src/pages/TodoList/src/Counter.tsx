import { decrement, increment, incrementAsync, incrementByAmount, incrementIfOdd, selectCount } from '@/store/counter/reducer'
...
export default function Counter() {
  ...
  const incrementValue = incrementAmount !== null ? Number(incrementAmount) : 0
