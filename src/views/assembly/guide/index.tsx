...
const guide = () => {
	...
	const startIntro = () => {
		...
		intro.setOptions({
			steps: [
				{
					element: document.querySelector("#step1")! as unknown as any, // 定位到相应的元素位置，如果不设置element，则默认展示在屏幕中央
					title: "Welcome", // 标题
					intro: "Hello World! 👋" // 内容
				},
				{
					element: document.querySelector("#step2")! as unknown as any, // 定位到相应的元素位置，如果不设置element，则默认展示在屏幕中央
					title: "Welcome", // 标题
					intro: "Hello World! 👋" // 内容
				}
			]
